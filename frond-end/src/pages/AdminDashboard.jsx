...
const baseProcessSteps = [
  {
    ...
    description: 'Data pengajuan diterima dari mahasiswa',
    icon: DocumentIcon,
    from: '#7C3AED',
    to: '#6D28D9',
  },
  {
    ...
    description: 'Periksa kelengkapan & kesesuaian data',
    icon: SearchIcon,
    from: '#FF9640',
    to: '#F97316',
  },
  {
    ...
    description: 'Tinjau pemetaan aktivitas, CPMK, dan mata kuliah',
    icon: RefreshIcon,
    from: '#C084FC',
    to: '#9333EA',
  },
  {
    ...
    description: 'Pantau bukti serta penilaian Mitra dan DPL',
    icon: UploadIcon,
    from: '#FBBF24',
    to: '#D97706',
  },
...
const NAV_ITEMS = [
  ...
  { label: 'Daftar Pengajuan', href: '#pengajuan', icon: LayersIcon },
...
function AdminDashboard() {
  ...
  const initials = getInitials('Admin Program Studi')
        ...
        <div className="flex min-w-0 flex-col">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base font-semibold text-slate-900 sm:text-lg">
                  Pantau pengajuan konversi magang
                </h1>
          ...
          <div className="flex flex-col justify-between gap-6 rounded-3xl bg-[#7C3AED] p-8 sm:flex-row sm:items-center">
            <div>
              ...
              <h2 className="mt-4 text-2xl font-semibold text-white sm:text-3xl">
                Selamat datang, Admin! <span className="align-middle">👋</span>
              </h2>
              <p className="mt-2 max-w-lg text-sm leading-6 text-white/60">
                Pantau dan verifikasi pengajuan konversi magang mahasiswa.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <GradientStatCard
              ...
              value={hasSubmission ? '1 Pengajuan' : 'Belum Ada'}
            ...
            <GradientStatCard
              ...
              value={waitingVerification > 0 ? 'Perlu Tindakan' : 'Kosong'}
            ...
            <GradientStatCard
              ...
              label="Terverifikasi"
              value={verified > 0 ? '1 Pengajuan' : 'Kosong'}
            ...
            {internshipList.length > 0 ? (
              ...
              <div className="mt-4 rounded-xl border border-dashed border-slate-200 px-6 py-10 text-center">
                ...
                <p className="mx-auto mt-2 max-w-lg text-sm leading-6 text-slate-400">
                  Pengajuan mahasiswa akan ditampilkan di sini setelah
                  mereka mengirimkan data magang.
                </p>
              </div>
            )}
          </div>
...
function getActionContent(internship, hasSubmission) {
  if (!hasSubmission) {
    return {
      heroDescription:
        'Belum ada pengajuan magang yang masuk dari mahasiswa.',
      badge: 'Menunggu',
      title: 'Belum ada pengajuan masuk',
      description:
        'Tindakan akan muncul di sini setelah mahasiswa mengirimkan pengajuan magang.',
      buttonLabel: '',
      showButton: false,
      panelClass: 'border-slate-100 bg-slate-50',
  ...
  if (internship.status === 'MENUNGGU_VERIFIKASI') {
    return {
      heroDescription:
        'Ada pengajuan mahasiswa yang menunggu verifikasi Prodi.',
      badge: 'Perlu Tindakan',
      title: 'Verifikasi pengajuan mahasiswa',
      description:
        'Periksa data mitra, posisi, periode, pembimbing Mitra, dan DPL sebelum disetujui.',
  ...
  if (internship.status === 'PERLU_PERBAIKAN_PENGAJUAN') {
    return {
      heroDescription:
        'Menunggu mahasiswa memperbaiki data pengajuan sesuai catatan.',
      badge: 'Menunggu Mahasiswa',
      title: 'Menunggu perbaikan dari mahasiswa',
      description:
        'Catatan perbaikan sudah dikirim. Pengajuan akan kembali muncul di sini setelah direvisi.',
  ...
  if (internship.status === 'MAGANG_TERVERIFIKASI') {
    return {
      heroDescription:
        'Pengajuan telah terverifikasi, siap lanjut ke usulan konversi.',
      badge: 'Terverifikasi',
      title: 'Lanjutkan ke usulan konversi',
      description:
        'Pengajuan telah terverifikasi. Pantau pemetaan CPMK dan mata kuliah pada tahap berikutnya.',
  ...
  return {
    heroDescription: 'Pantau proses konversi magang mahasiswa.',
    badge: 'Info',
    title: getStatusLabel(internship.status),
    description: 'Buka detail pengajuan untuk melihat progres terbaru.',
    buttonLabel: 'Buka Detail',
    showButton: true,
...
/* Colorful gradient stat card with a circular progress ring, matching the
   student dashboard's card layout: bold gradient, big label, ring
   bottom-left, faint decorative icon on the right. */
